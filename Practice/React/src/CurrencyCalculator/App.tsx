                ...
                <div className="form-group">
                    <div className="form-section">
                        ...
                        <div className="currency-selection">
                            <img src="https://flagsapi.com/NP/flat/64.png" alt="" />
...
<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
	 width="30px" height="25px" viewBox="0 0 511.624 511.623">
<g>
	<g>
...
<g>
                ...
                <button type="submit" className="submit-buttom"> Get Exchange Rate</button>

                <p className="exchange-result">1 NPR = 100 INR </p>
            </form>
        </div>
        </>
    );
